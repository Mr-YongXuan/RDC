...
@ApiModel(description = "友军击杀事件")
public class FriendlyKillEvent extends BaseEvent implements Serializable {
    ...
    public FriendlyKillEvent() {
        super(EventType.FRIENDLY_KILL, null, null);
    }

    public FriendlyKillEvent(String playerName, String playerUcid, String playerType, Integer playerSide, String victimName, Integer victimSide, String victimType, String victimUcid, String weaponUsed) {
        super(EventType.FRIENDLY_KILL, playerName, playerUcid);
