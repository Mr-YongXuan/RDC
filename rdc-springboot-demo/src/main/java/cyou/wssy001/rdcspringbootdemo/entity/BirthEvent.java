...
@ApiModel(description = "单位出生事件")
public class BirthEvent extends BaseEvent implements Serializable {
    ...
    public BirthEvent() {
        super(EventType.BIRTH, null, null);

    }

    public BirthEvent(String playerName, String playerUcid, String callsign, Integer coalition, boolean isAi, String pilotName, String playerType, Double time) {
        super(EventType.BIRTH, playerName, playerUcid);
