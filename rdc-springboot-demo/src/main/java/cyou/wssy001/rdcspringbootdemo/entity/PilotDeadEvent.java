...
@ApiModel(description = "飞行员阵亡事件")
public class PilotDeadEvent extends BaseEvent implements Serializable {
    ...
    public PilotDeadEvent() {
        super(EventType.PILOT_DEAD, null, null);

    }

    public PilotDeadEvent(String playerName, String playerUcid, String callsign, Integer coalition, boolean isAi, String pilotName, String playerType, Double time) {
        super(EventType.PILOT_DEAD, playerName, playerUcid);
