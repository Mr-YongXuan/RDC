...
@ApiModel(description = "撞机事件")
public class CrashEvent extends BaseEvent implements Serializable {
    ...
    public CrashEvent() {
        super(EventType.CRASH, null, null);

    }

    public CrashEvent(String playerName, String playerUcid, String callsign, Integer coalition, boolean isAi, String pilotName, String playerType, Double time) {
        super(EventType.CRASH, playerName, playerUcid);
