...
@ApiModel(description = "弹射事件")
public class EjectEvent extends BaseEvent implements Serializable {
    ...
    public EjectEvent() {
        super(EventType.EJECTION, null, null);

    }

    public EjectEvent(String playerName, String playerUcid, String callsign, Integer coalition, boolean isAi, String pilotName, String playerType, Double time) {
        super(EventType.EJECTION, playerName, playerUcid);
