...
@ApiModel(description = "单位阵亡事件")
public class DeadEvent extends BaseEvent implements Serializable {
    ...
    public DeadEvent() {
        super(EventType.DEAD, null, null);

    }

    public DeadEvent(String playerName, String playerUcid, String callsign, Integer coalition, boolean isAi, String pilotName, String playerType, Double time) {
        super(EventType.DEAD, playerName, playerUcid);
