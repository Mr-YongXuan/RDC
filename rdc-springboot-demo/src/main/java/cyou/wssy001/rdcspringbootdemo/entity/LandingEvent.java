...
@ApiModel(description = "着陆事件")
public class LandingEvent extends BaseEvent implements Serializable {
    ...
    public LandingEvent() {
        super(EventType.LAND, null, null);

    }

    public LandingEvent(String basename, String callsign, Integer coalition, boolean isAi, String pilotName, String playerName, String playerType, String playerUcid, Double time) {
        super(EventType.LAND, playerName, playerUcid);
