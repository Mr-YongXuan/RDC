...
@ApiModel(description = "发动机关闭事件")
public class EngineShutDownEvent extends BaseEvent implements Serializable {
    ...
    public EngineShutDownEvent() {
        super(EventType.ENGINE_SHUT_DOWN, null, null);

    }

    public EngineShutDownEvent(String playerName, String playerUcid, String callsign, Integer coalition, boolean isAi, String pilotName, String playerType, Double time) {
        super(EventType.ENGINE_SHUT_DOWN, playerName, playerUcid);
